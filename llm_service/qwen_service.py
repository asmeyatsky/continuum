...
Provides LLM interactions using Alibaba Cloud's Qwen API.
"""
import logging
...
class QwenService(LLMService):
    ...
    def __init__(self):
        ...
        try:
            ...
            # Qwen supports OpenAI compatibility, use the same client
        ...
        logger.info(f"Qwen service initialized with model: {self.model}")
